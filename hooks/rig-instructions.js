#!/usr/bin/env node
// Shared Rig instruction builder for Claude hooks and Pi extension.
...
function getFallbackInstructions(mode) {
  return 'RIG MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    '## Persistence\n\n' +
    'ACTIVE EVERY RESPONSE. No drift back to over-building. Still active if unsure. Off only: "stop rig" / "normal mode".\n\n' +
    'Current level: **' + mode + '**. Switch: `/rig lite|full|ultra`.\n\n' +
    '## The ladder\n\n' +
    ...
    'Mark intentional simplifications with a `rig:` comment — a shortcut with a known ceiling names the ceiling and the upgrade path in the comment.\n\n' +
    '## Output\n\n' +
    ...
    '## Boundaries\n\n' +
    'Rig governs what you build, not how you talk. "stop rig" or "normal mode": revert. Level persists until changed or session end.';
}
