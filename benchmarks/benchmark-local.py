"""
Rig local benchmark — runs the same 5 tasks against any Ollama model.
No promptfoo required. Compares baseline vs caveman vs rig on code LOC
...
def load_arms():
    return {
        ...
        "rig": (ROOT / "skills/rig/SKILL.md").read_text(encoding="utf-8"),
    }
...
def main():
    parser = argparse.ArgumentParser(description="Rig local benchmark via Ollama")
