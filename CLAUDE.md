...
- `rig/tier-1/rules/ponytail.md` activates the implementation rule.
- `skills/ponytail/SKILL.md` is the unchanged Ponytail source component.
...
The rest of the repository is the existing Ponytail component and its adapters.
